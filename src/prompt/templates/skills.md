...
For role-specific tasks, also read the relevant skill (dev-frontend, dev-uiux-design, dev-backend, dev-data, dev-testing, dev-security, dev-debugging, dev-architecture, dev-code-reviewer, dev-scaffolding).
